...
BLOG_AUTHOR = "Juliana Karoline de Sousa"  # (translatable)
BLOG_TITLE = "Juliana Karoline de Sousa"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://julianaklulo.dev/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://julianaklulo.dev/"
BLOG_EMAIL = "julianaklulo@gmail.com"
BLOG_DESCRIPTION = {
    "en": "Blog to share my personal projects",
    "pt_br": "Blog para compartilhar meus projetos pessoais"
}
...
NAVIGATION_LINKS = {
    "en": (
        ("/en/pages/presentations/", "Talks and Tutorials"),
        ("/en/blog/", "Blog"),

    ),

    "pt_br": (
        ("/pages/apresentações/", "Palestras e Tutoriais"),
        ("/blog/", "Blog"),

    ),
}
TRANSLATE_NAME_IN_LINKS = True
...
LUXON_DATE_FORMAT = {
    'en': {'preset': False, 'format': 'MM/dd/yyyy HH:mm'},
    "pt_br": {'preset': False, 'format': 'dd/MM/yyyy HH:mm'},
}
...
INDEX_READ_MORE_LINK = {
    ...
    "en": '<p class="more"><a href="{link}">{read_more}...</a></p>',
}
